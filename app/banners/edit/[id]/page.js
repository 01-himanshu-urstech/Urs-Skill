...
export default function EditBannerPage() {
    ...
    const validateForm = () => {
        ...
        // else if (formData.title.length > 16)
        //     newErrors.title = "Title must not exceed 16 characters";

        // if (formData.subtitle && formData.subtitle.length > 20)
        //     newErrors.subtitle = "Subtitle must not exceed 20 characters";
