    ...
    if (isLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh]">
                ...
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Verifying Authorization...</p>
            </div>
        );
    }
    ...
    if (!isAuthorized) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[70vh] p-8 text-center bg-white rounded-[3rem] border border-gray-100 shadow-xl m-4 animate-in fade-in zoom-in-95 duration-500">
                ...
                <h1 className="text-xl font-black text-gray-800 uppercase tracking-tight mb-2">Access Denied</h1>
                ...
                <button
                    onClick={() => router.push("/")}
                    className="mt-8 px-10 py-4 bg-gray-900 text-white rounded-2xl font-black uppercase text-[10px] tracking-widest hover:bg-black transition-all active:scale-95"
                >
                    Back to Safety
                </button>
            </div>
