                ...
                <div className="mt-6 mb-6 flex flex-col sm:flex-row gap-4 items-center justify-between">
                    <div className="relative w-full max-w-md">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-2xl outline-none shadow-sm focus:ring-4 focus:ring-[#7C3AED]/5 transition-all text-sm font-medium"
                        />
                    </div>
                    <button
                        onClick={refetch}
                        disabled={isLoading || isFetching}
                        className="w-full sm:w-auto px-8 py-3 bg-white hover:bg-gray-50 text-gray-700 border hover:cursor-pointer border-gray-100 rounded-2xl font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-3 transition-all shadow-sm active:scale-95 disabled:opacity-50"
                    >
                                        ...
                                        <tr key={log._id} className="hover:bg-gray-50/50 transition-colors group">
                                            ...
                                            <td className="p-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className="text-sm font-black text-gray-700 uppercase tracking-tight">{log.performedBy?.role}</span>
                                                </div>
                                            </td>

                                            <td className="p-6 text-center">
                                                <div className="flex flex-col items-center gap-1">
                                                    <span className={`px-2 py-1 rounded text-[10px] font-black uppercase tracking-wider ${log.action?.includes('DELETE') ? 'bg-red-50 text-red-500' :
