...
//                     {error && (
//                         <div className="p-4 bg-red-50 border-2 border-red-100 text-red-600 rounded-2xl text-[10px]   uppercase tracking-widest flex items-center gap-3 animate-in fade-in slide-in-from-top-2">
...
//                                             <button type="button" onClick={generateCode} className="w-full sm:w-auto h-14 sm:h-16 px-10 bg-indigo-50 text-indigo-600 border-2 border-indigo-100 rounded-2xl   uppercase text-[11px] tracking-widest hover:bg-indigo-600 hover:text-white transition-all">Auto-Gen</button>
//                                         </div>
//                                     </div>
//                                     <div className="space-y-3">
//                                         <label className="text-[10px]   text-gray-400 uppercase tracking-widest ml-1">Internal Description ({formData.description.length}/120)</label>
...
//                                             <label className="text-[11px]   text-gray-400 uppercase tracking-widest ml-1">Validity Window *</label>
...
//                                                 </div>
//                                                 <span className="text-[10px]   text-gray-300 uppercase text-center">To</span>
//                                                 <div className="relative w-full">
//                                                     <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 text-indigo-500" size={18} />
...
//                                         <label className="text-[11px]   text-gray-400 uppercase tracking-widest block ml-1">Discount Calculation</label>
...
//                                 {activeTab !== "information" && (
//                                     <button type="button" onClick={() => setActiveTab(activeTab === "actions" ? "conditions" : "information")} className="w-full sm:w-auto hover:cursor-pointer px-10 py-4 sm:py-5 text-gray-400   uppercase text-[10px] tracking-widest hover:text-indigo-600 transition-all text-center">Back</button>
//                                 )}
//                                 {activeTab === "actions" ? (
//                                     <button type="submit" disabled={isLoading} className="w-full sm:w-auto hover:cursor-pointer px-12 py-4 sm:py-5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-[1.5rem]   uppercase text-[10px] tracking-widest shadow-2xl transition-all flex items-center justify-center gap-3 active:scale-95 disabled:opacity-50">
//                                         {isLoading ? <RefreshCw className="animate-spin" size={16} /> : <Check size={18} />} Publish Rule
//                                     </button>
//                                 ) : (
//                                     <button type="button" onClick={() => handleNext(activeTab === "information" ? "conditions" : "actions")} className="w-full sm:w-auto hover:cursor-pointer px-12 py-4 sm:py-5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-[1.5rem]   uppercase text-[10px] tracking-widest shadow-2xl transition-all flex items-center justify-center gap-3 active:scale-95">
...
//         <span className="text-[9px] sm:text-[11px]   uppercase tracking-widest">{label}</span>
//     </button>
// );

// const InputField = ({ label, onChange, ...props }) => (
//     <div className="flex flex-col gap-2 sm:gap-3 w-full text-black">
//         <label className="text-[10px] sm:text-[11px]   text-gray-400 uppercase tracking-widest ml-1">{label}</label>
//         <input {...props} onChange={onChange} className="w-full h-14 sm:h-16 px-5 sm:px-8 bg-gray-50/50 border-2 border-gray-100 rounded-2xl focus:outline-none focus:border-indigo-500 font-bold sm:  text-sm sm:text-lg transition-all" />
//     </div>
// );
...
//         </div>
//         <span className={`text-[10px] sm:text-[12px]   uppercase tracking-wider ${active ? 'text-gray-900' : 'text-gray-400'}`}>{label}</span>
//     </button>
// );
                            ...
                            {activeTab === "conditions" && (
                                <div className="space-y-10 lg:space-y-12 animate-in fade-in duration-300 text-black">
                                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 lg:gap-12">
                                        ...
                                        <div className="space-y-3">
                                            <label className="text-[11px]   text-gray-400 uppercase tracking-widest ml-1 flex items-center gap-2">
